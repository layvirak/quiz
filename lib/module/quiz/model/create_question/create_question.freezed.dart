...
class _$CreateQuestionModelImpl implements _CreateQuestionModel {
  ...
  @override
  String toString() {
    return 'CreateQuestionModel(name: $name, owner: $owner, creation: $creation, modified: $modified, modifiedBy: $modifiedBy, docstatus: $docstatus, idx: $idx, question: $question, duration: $duration, parent: $parent, parentfield: $parentfield, parenttype: $parenttype, doctype: $doctype)';
  }
